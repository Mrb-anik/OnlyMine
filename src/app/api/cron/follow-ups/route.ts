        ...
        html: `
          <div style="font-family: sans-serif; background: #0A0E27; color: #fff; padding: 40px; border-radius: 16px; max-width: 600px; margin: 0 auto;">
            ...
            <div style="margin: 32px 0;">
               <a href="https://cal.com/leadmatrix/audit-call" style="display: inline-block; background: #FF6B35; color: #000; padding: 14px 28px; border-radius: 8px; text-decoration: none; font-weight: 800; font-size: 16px;">
